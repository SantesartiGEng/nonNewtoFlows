function gradpTPL = funct_gradpTPL(gradpNewto_mu0, gradpPowlaw, gradpNewto_muInf, Q, R, mu0, tau0, K, n, muInf, tauInf)
    % This function computes the gradp of a TPL fluid flowing in a conical
